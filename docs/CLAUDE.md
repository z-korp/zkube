...
| File | Description |
|------|-------------|
| `/CLAUDE.md` | Main project overview (comprehensive) |
| `/contracts/CLAUDE.md` | Smart contract documentation |
| `/client-budokan/CLAUDE.md` | Frontend documentation |
| `/packages/token/CLAUDE.md` | ERC20 test token documentation |
| `/packages/game_erc721/CLAUDE.md` | ERC721 NFT documentation |
| `/scripts/CLAUDE.md` | Deployment scripts documentation |
