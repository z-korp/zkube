...
const toastColor = (type: string) => {
  if (type === "success") return color.status.successDark;
  if (type === "error") return color.status.dangerDark;
  if (type === "info") return 0x1e3a8a;
  return color.bg.primary;
};

const toastBorder = (type: string) => {
  if (type === "success") return color.status.success;
  if (type === "error") return color.status.danger;
