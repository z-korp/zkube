                ...
                <div className="relative w-full">
                  ...
                  >
                    <GameBoard
                      ...
                      // and torii indexing
                      initialGrid={grid}
                      nextLine={gameIsOver ? [] : game.next_row}
                      score={gameIsOver ? 0 : game.score}
                      combo={gameIsOver ? 0 : game.combo}
                      maxCombo={gameIsOver ? 0 : game.max_combo}
                      hammerCount={
                        gameIsOver ? 0 : game.hammer - game.hammer_used
                      }
                      totemCount={gameIsOver ? 0 : game.totem - game.totem_used}
                      waveCount={gameIsOver ? 0 : game.wave - game.wave_used}
                      account={account}
                      game={game}
                    />
                  </div>
