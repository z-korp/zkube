...
export const STREAK_1_7_MULTIPLIER_START = 1.0; // 1.0x
export const STREAK_1_7_MULTIPLIER_INCREMENT = 0.01; // +0.01x per day

export const STREAK_8_30_MULTIPLIER_START = 1.08; // 1.08x
export const STREAK_8_30_MULTIPLIER_INCREMENT = 0.003; // +0.003x per day

export const STREAK_31_PLUS_MULTIPLIER = 1.2; // 1.20x
export const STREAK_CAP = 1.4; // 1.40x cap for streaks above 60 days
...
// Game mode
export const GAME_MODE_PAID_MULTIPLER = 1.5; // 1.50x if paid game
export const GAME_MODE_FREE_MULTIPLER = 1.0; // 1.10x if free game
