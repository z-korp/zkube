...
pub trait IERC721Mintable<TContractState> {
    ...
    fn update_base_uri(ref self: TContractState, new_uri: ByteArray);
}
...
mod ERC721 {
    ...
    impl ERC721MetadataImpl of IERC721Metadata<ContractState> {
        ...
        fn token_uri(self: @ContractState, token_id: u256) -> ByteArray {
            ...
            // Return your constant token URI
    ...
    impl ExternalImpl of ExternalTrait {
        ...
        fn update_base_uri(ref self: ContractState, new_uri: ByteArray) {
            ...
            self.constant_token_uri.write(new_uri);
            self.erc721._set_base_uri(self.constant_token_uri.read());
        }
