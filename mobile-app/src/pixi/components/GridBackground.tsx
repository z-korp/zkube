...
export const GridBackground = ({
  ...
  const drawGrid = useCallback((g: PixiGraphics) => {
    ...
    g.setStrokeStyle({ width: 0.5, color: 0x1a2d4a, alpha: 0.2 });
    ...
    g.roundRect(0, 0, width, height, radius);
    g.stroke({ color: 0x1e3a5f, width: 1.5, alpha: 0.4 });
  ...
  }, [gridSize, gridWidth, gridHeight, width, height, colors, dangerAlpha]);
