...
pub mod AccessControlComponent {
    use zkube::tests::mocks::openzeppelin::access::accesscontrol::interface;
    use zkube::tests::mocks::openzeppelin::introspection::src5::SRC5Component::InternalImpl as SRC5InternalImpl;
