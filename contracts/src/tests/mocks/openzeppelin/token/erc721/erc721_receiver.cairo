...
// OpenZeppelin Contracts for Cairo v0.18.0 (token/erc721/erc721_receiver.cairo)
...
pub mod ERC721ReceiverComponent {
    use zkube::tests::mocks::openzeppelin::token::erc721::interface::IERC721_RECEIVER_ID;
    use zkube::tests::mocks::openzeppelin::token::erc721::interface::{
        IERC721Receiver, IERC721ReceiverCamel
    };
    use zkube::tests::mocks::openzeppelin::token::erc721::interface;
