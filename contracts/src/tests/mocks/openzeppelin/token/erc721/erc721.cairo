...
// OpenZeppelin Contracts for Cairo v0.18.0 (token/erc721/erc721.cairo)
...
pub mod ERC721Component {
    ...
    use zkube::tests::mocks::openzeppelin::token::erc721::interface;
    use zkube::tests::mocks::openzeppelin::introspection::interface::{
        ISRC5Dispatcher, ISRC5DispatcherTrait
    };
    use zkube::tests::mocks::openzeppelin::account::interface::{ISRC6_ID};
