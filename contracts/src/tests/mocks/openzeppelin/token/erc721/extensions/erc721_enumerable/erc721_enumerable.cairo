...
pub mod ERC721EnumerableComponent {
    ...
    use zkube::tests::mocks::openzeppelin::token::erc721::ERC721Component::ERC721Impl;
    use zkube::tests::mocks::openzeppelin::token::erc721::ERC721Component::InternalImpl as ERC721InternalImpl;
    use zkube::tests::mocks::openzeppelin::token::erc721::ERC721Component;
    use zkube::tests::mocks::openzeppelin::token::erc721::extensions::erc721_enumerable::interface::IERC721Enumerable;
    use zkube::tests::mocks::openzeppelin::token::erc721::extensions::erc721_enumerable::interface;
