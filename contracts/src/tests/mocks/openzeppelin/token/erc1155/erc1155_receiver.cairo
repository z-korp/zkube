...
// OpenZeppelin Contracts for Cairo v0.18.0 (token/erc1155/erc1155_receiver.cairo)
...
pub mod ERC1155ReceiverComponent {
    use zkube::tests::mocks::openzeppelin::token::erc1155::interface::IERC1155_RECEIVER_ID;
    use zkube::tests::mocks::openzeppelin::token::erc1155::interface::{
