...
pub mod ERC20Component {
    ...
    use zkube::tests::mocks::openzeppelin::token::erc20::interface;
    use zkube::tests::mocks::openzeppelin::token::erc20::snip12_utils::permit::Permit;
    use zkube::tests::mocks::openzeppelin::account::interface::{
        ISRC6Dispatcher, ISRC6DispatcherTrait
    };
    use zkube::tests::mocks::openzeppelin::utils::cryptography::interface::{
        INonces, ISNIP12Metadata
    };
    use zkube::tests::mocks::openzeppelin::utils::cryptography::snip12::{
        StructHash, OffchainMessageHash, SNIP12Metadata, StarknetDomain
    };
    use zkube::tests::mocks::openzeppelin::utils::cryptography::nonces::NoncesComponent::InternalTrait as NoncesInternalTrait;
    use zkube::tests::mocks::openzeppelin::utils::cryptography::nonces::NoncesComponent;
