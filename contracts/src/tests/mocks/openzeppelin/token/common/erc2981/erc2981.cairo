...
// OpenZeppelin Contracts for Cairo v0.18.0 (token/common/erc2981/erc2981.cairo)
...
pub mod ERC2981Component {
    ...
    use zkube::tests::mocks::openzeppelin::token::common::erc2981::interface::{
        IERC2981, IERC2981_ID
    };
