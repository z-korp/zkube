...
/// DailyClearerOne - Clear 25 lines (rewards 3 CUBE)
pub impl DailyClearerOne of QuestTrait {
    ...
    fn props(registry: ContractAddress) -> QuestProps {
        ...
        let metadata = QuestMetadataTrait::new(
            name: "Line Breaker",
            description: "Clear 25 lines to warm up.",
            icon: "fa-minus",
            registry: registry,
...
/// DailyClearerTwo - Clear 50 lines (rewards 5 CUBE)
...
/// DailyClearerThree - Clear 100 lines (rewards 10 CUBE)
