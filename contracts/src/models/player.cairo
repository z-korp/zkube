...
impl PlayerImpl of PlayerTrait {
    ...
    fn new(id: felt252, name: felt252) -> Player {
        ...
        // [Return] Player
        Player { id, game_id: 0, hammer_bonus: 0, wave_bonus: 0, totem_bonus: 0, name, points: 0 }
    }
    ...
    #[inline(always)]
    fn update(ref self: Player, hammer: u8, totem: u8, wave: u8, points: u32) {
...
impl ZeroablePlayerImpl of core::Zeroable<Player> {
    ...
    fn zero() -> Player {
        Player {
            id: 0, game_id: 0, hammer_bonus: 0, wave_bonus: 0, totem_bonus: 0, name: 0, points: 0
        }
    }
