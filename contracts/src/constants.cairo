...
// Modes
const DAILY_MODE_PRICE: u128 = 10000000000000000000; // 10 LORDS //5000000000000; // = 0.000005 ETH
const DAILY_MODE_DURATION: u64 = 86400; // = 1 day = 24x60x60
//const DAILY_MODE_DURATION: u64 = 3600; // 1h

const NORMAL_MODE_PRICE: u128 = 10000000000000000000; // 10 LORDS
...
const SECONDS_PER_DAY: u64 = 86400; // 24x60x60
