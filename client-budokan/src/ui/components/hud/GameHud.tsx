...
const GameHud: React.FC<GameHudProps> = ({
  ...
  return (
    <div className="w-full px-2 pt-2 shrink-0">
      <div className="max-w-[500px] mx-auto w-full bg-slate-900/90 backdrop-blur-sm border border-slate-500/50 rounded-lg px-3 py-2 flex flex-col gap-1.5">
        <div className="flex items-center gap-2">
          ...
          <span className={`font-['Tilt_Prism'] text-sm tabular-nums shrink-0 ${combo > 0 ? "text-white" : "text-slate-500"}`}>
            🔥{combo}x
          </span>
