  ...
  return (
    <div className="flex items-center justify-between gap-1.5 px-2 py-1.5 bg-slate-900/60 backdrop-blur-sm rounded-lg">
      ...
      <div className="flex items-center gap-0.5 min-w-0">
        <span className="font-['Fredericka_the_Great'] text-sm text-cyan-400 tabular-nums">
          {animatedScore}
        </span>
        <span className="text-slate-500 text-xs">/</span>
        <span className="font-['Fredericka_the_Great'] text-sm text-slate-400 tabular-nums">
          {targetScore}
        </span>
      </div>
      ...
      <div className="flex items-center gap-0.5 min-w-0">
        <span
          className={`font-['Fredericka_the_Great'] text-sm tabular-nums ${
            isOut
              ? "text-red-500"
              : isDanger
                ? "text-orange-400"
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        ...
        <span className="font-['Fredericka_the_Great'] text-sm text-yellow-400 tabular-nums">
          {totalCubes}
        </span>
      </div>
    </div>
