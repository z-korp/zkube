          ...
          >
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="text-right">
                ...
                <p className="font-['Bangers'] text-4xl leading-none text-yellow-300">{cubesAvailable}</p>
              </div>
            </div>
          </motion.div>
            ...
            <>
              ...
              >
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="font-['Bangers'] text-2xl text-emerald-200">{chargeCost} 🧊</span>
                </div>
                      ...
                      >
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="font-['Bangers'] text-xl leading-none text-emerald-200">
              ...
              >
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="font-['Bangers'] text-2xl text-violet-100">{LEVEL_UP_COST} 🧊</span>
                </div>
                  ...
                  {selectedBonuses.map((bonus, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="mb-2 font-['Bangers'] text-2xl leading-none text-violet-100">
              ...
              >
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="font-['Bangers'] text-2xl text-amber-100">{SWAP_BONUS_COST} 🧊</span>
                </div>
