...
// Themes 1-2 use legacy file names (jungle series), 3-10 use main/map/level/boss
export const THEME_MUSIC: Record<ThemeId, Record<MusicContext, string>> = {
  "theme-1": {
    main: "/assets/theme-1/sounds/musics/theme-jungle2.mp3",
    map: "/assets/theme-1/sounds/musics/intro.mp3",
    level: "/assets/theme-1/sounds/musics/theme-jungle3.mp3",
    boss: "/assets/theme-1/sounds/musics/theme-jungle.mp3",
  },
  "theme-2": {
    main: "/assets/theme-2/sounds/musics/theme-jungle2.mp3",
    map: "/assets/theme-2/sounds/musics/theme-jungle2.mp3",
    level: "/assets/theme-2/sounds/musics/theme-jungle3.mp3",
    boss: "/assets/theme-2/sounds/musics/theme-jungle3.mp3",
  },
  "theme-3": {
    main: "/assets/theme-3/sounds/musics/main.mp3",
    map: "/assets/theme-3/sounds/musics/map.mp3",
  ...
  "theme-4": {
    ...
    map: "/assets/theme-4/sounds/musics/map.mp3",
  ...
  "theme-5": {
    ...
    map: "/assets/theme-5/sounds/musics/map.mp3",
  ...
  "theme-6": {
    ...
    map: "/assets/theme-6/sounds/musics/map.mp3",
  ...
  "theme-7": {
    ...
    map: "/assets/theme-7/sounds/musics/map.mp3",
  ...
  "theme-8": {
    ...
    map: "/assets/theme-8/sounds/musics/map.mp3",
  ...
  "theme-9": {
    ...
    map: "/assets/theme-9/sounds/musics/map.mp3",
  ...
  "theme-10": {
    ...
    map: "/assets/theme-10/sounds/musics/map.mp3",
...
// Themes 1-2 lack grid-bg, grid-frame, background, theme-icon assets
