...
export const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  { id: feltFromShortString("BOSS_SLAYER_III"), shortId: "BOSS_SLAYER_III", name: "Guardian Slayer III", description: "Clear 15 guardians", target: 15, xp: 300, category: "Guardian Slayer", tier: 3, icon: "👹", taskId: feltFromShortString("BOSS_DEFEAT") },
  { id: feltFromShortString("BOSS_SLAYER_IV"), shortId: "BOSS_SLAYER_IV", name: "Guardian Slayer IV", description: "Clear 50 guardians", target: 50, xp: 500, category: "Guardian Slayer", tier: 4, icon: "👑", taskId: feltFromShortString("BOSS_DEFEAT") },

  { id: feltFromShortString("EXPLORER_I"), shortId: "EXPLORER_I", name: "Explorer I", description: "Complete 1 zone", target: 1, xp: 100, category: "Explorer", tier: 1, icon: "🗺️", taskId: feltFromShortString("ZONE_COMPLETE") },
  { id: feltFromShortString("EXPLORER_II"), shortId: "EXPLORER_II", name: "Explorer II", description: "Complete 3 zones", target: 3, xp: 200, category: "Explorer", tier: 2, icon: "🌍", taskId: feltFromShortString("ZONE_COMPLETE") },
