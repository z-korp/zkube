    ...
    MutatorDef: (() => {
      return defineComponent(
        world,
        {
          ...
          score_mult_x100: RecsType.Number,
          ...
          combo_bonus_mult_x100: RecsType.Number,
          bonus_type: RecsType.Number,
          combo_trigger_threshold: RecsType.Number,
          lines_trigger_threshold: RecsType.Number,
          score_trigger_threshold: RecsType.Number,
